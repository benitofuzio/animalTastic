var animals = ["Grumpy Cat", "Lil' Bib the cat", "Marnie the dog", "Free Willy", "Sockington the cat", "Biddy the Hedgehog", "Garfield", "Hello Kitty", "Mickey Mouse", "Goofy", "Donald Duck"];
